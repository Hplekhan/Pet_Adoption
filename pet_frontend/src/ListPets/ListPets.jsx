...
const ListPets = () => {
  ...
  const filterPets = () => {
    ...
    return petsData.filter(
      (category) => category.type === selectedCategory.toLowerCase()
    );
  };
  ...
  return (
    <>
      ...
      <div className="text-center mt-4">
        <h3 style={{ fontFamily: "Copperplate" }}>Want to add your Pet ?</h3>
        <div>
          {isLogin ? (
                  ...
                  <Row>
                    <Col xs={6} md={6}>
                      <Form.Group controlId="species">
                        <Form.Select onChange={handleSpeciesChange} required>
        ...
        <div className="btn-group" role="group" aria-label="Basic example">
          <button
            ...
            onClick={() => setSelectedCategory("All Pets")}
          >
            ALL
          </button>
          <button
          ...
          <Modal show={showModal} onHide={handleCloseModal}>
            ...
            <Modal.Body>
              <img
                ...
                className="img-fluid"
                style={{ maxWidth: "60%", maxHeight: "120px" }}
              />
              <Form>
                <Form.Group controlId="formUsername">
                  ...
                  <Form.Control
                    ...
                    style={{ maxWidth: "90%", border: "2px solid black" }}
                  />
                </Form.Group>
